...
pub fn day1_puzzle1_challenge(buffer: String) {
    ...
    for line in buffer.lines() {
        ...
        location_id_lists
            .left_list
            .push(left_item.trim().parse().unwrap());
        location_id_lists
            .right_list
            .push(right_item.trim().parse().unwrap());
    }
    ...
    let pairs_list = location_id_lists
        .left_list
        .iter()
        .zip(location_id_lists.right_list);
...
pub fn day1_puzzle2_challenge(buffer: String) {
